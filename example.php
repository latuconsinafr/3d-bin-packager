...
// Initialize the bin
$packager->addBin(new Bin(20.5, 12.25, 5.4, 20.2));

// Initialize the item one by one
// $packager->addItem(new Item(2.5, 5.5, 7.5, 10));
// $packager->addItem(new Item(1.5, 2.5, 4.3, 5.5));

// Initialize all the items once
$packager->addItems([
    new Item(2.5, 5.5, 7.5, 10),
    new Item(1.5, 2.5, 4.3, 5.5)
]);
